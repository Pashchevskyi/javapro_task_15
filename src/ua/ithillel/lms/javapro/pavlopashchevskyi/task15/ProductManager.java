...
public class ProductManager {
    ...
    /**
     * Gets Product instances, which type is "book" and they are discountable.
     * Makes discount 10% and returns list after that.
     *
     * @return List<Product>
     */
    ...
    /**
     * Calculates total price of Product instances, which type is "book" and price is non-greater than 75.
     *
     * @return double
     */
    ...
    /**
     * Groups Product instances by type. Returns map, which key is type and value is list of Product instances.
     *
